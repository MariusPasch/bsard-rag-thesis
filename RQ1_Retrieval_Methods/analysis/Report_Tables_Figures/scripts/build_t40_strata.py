"""
Build the Tier 4.0 stratified small-multiples figure.

Output: Report/figures/fig_rq1_t40_strata.{pdf,png}

Same shape as fig_rq1_t1_strata / fig_rq1_t2_strata / fig_rq1_t3_strata.
Shows the four canonical T4.0 systems plus the T3-A hybrid as a faded
reference bar so the per-stratum lift from "best non-LLM pipeline" to
"LLM-Judge re-rank" is readable.

Usage:
  .venv/Scripts/python Report/scripts/build_t40_strata.py
"""
...
PLOT_KEYS = [
    "llm_rerank_top50",
    "llm_rerank_top20",
    "llm_rerank_top50_bm25",
    "llm_rerank_0to10_top50_bm25",
    "hybrid_rrf_k60",            # T3-A reference
]
REFERENCE_KEY = "hybrid_rrf_k60"

OUTPUT_NAME = "fig_rq1_t40_strata"
