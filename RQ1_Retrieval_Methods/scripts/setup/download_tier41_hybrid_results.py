"""
Download T4.1-hybrid CRAG results from Azure Blob Storage after the Azure notebook run.

Usage:
    python scripts/setup/download_tier41_hybrid_results.py
...
DOWNLOADS = [
    (
        'results/agentic/CRAG/crag_hybrid_rrf_k60_test_v2.json',
        'results/agentic/CRAG/crag_hybrid_rrf_k60_test_v2.json',
        True,
    ),
]
